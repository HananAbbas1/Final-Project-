...
class Violationsall extends StatefulWidget {
  String Id;
  Violationsall({required this.Id});
  Uri _url = Uri.parse('');

  @override
  State<Violationsall> createState() => _ViolationsallState();
}

class _ViolationsallState extends State<Violationsall> {
  @override
  ...
  Widget violationsall(context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .where('campingnumber', isEqualTo: widget.Id)
          .snapshots(),
